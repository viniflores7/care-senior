class Routes {
  ...
  static const String appIntroScreen = '/intro';

  static const String guardianLoginScreen = '/guardian/login';
  ...
  static const String healthRecordRegisterScreen =
      '/staff/health-record-register';
